...
#
# Script generated by Vivado on Fri Nov 10 07:50:01 JST 2023
...
#
# Usage        : pll_pixelclock.sh
#                pll_pixelclock.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pll_pixelclock.sh [-reset_run]
#                pll_pixelclock.sh [-reset_log]
#                pll_pixelclock.sh [-help]
#
...
#                script (type 'pll_pixelclock.sh -help' for more information).
#
...
# script info
echo -e "pll_pixelclock.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pll_pixelclock.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.pll_pixelclock xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.pll_pixelclock -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/aokim/Company/RISCV/RockWave/SYNTH/Zedboard/Zedboard.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log pll_pixelclock_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: pll_pixelclock.sh [-step]\n\
Usage: pll_pixelclock.sh [-lib_map_path]\n\
Usage: pll_pixelclock.sh [-reset_run]\n\
Usage: pll_pixelclock.sh [-reset_log]\n\
Usage: pll_pixelclock.sh [-keep_index]\n\
